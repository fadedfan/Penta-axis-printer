...
//
  ...
  #define HOTEND0_BETA                 3834    // Beta value
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        360000 // (seconds)
...
#define CHAMBER_AUTO_FAN_PIN FAN3_PIN 
...
#define COOLER_AUTO_FAN_TEMPERATURE 15
...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 2, 25, 5 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      {2, 0, 0, 0, 0}       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define AXIS_RELATIVE_MODES { false, false, false, false ,false, true}
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 10*60, 100*60, 40*60, 2*60} // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define MIN_STEPS_PER_SEGMENT 9
 ...
 */
  ...
  #define INTERPOLATE      false
    ...
    #define X_CURRENT_HOME  780  // (mA) RMS current for homing. (Typically lower than *_CURRENT.)
    ...
    #define I_CURRENT     550
    #define I_CURRENT_HOME 500
    ...
    #define J_CURRENT      550
    #define J_CURRENT_HOME 500
  ...
  #define I_HYBRID_THRESHOLD       80  // [linear=mm/s, rotational=°/s]
  #define J_HYBRID_THRESHOLD       20  // [linear=mm/s, rotational=°/s]
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define I_STALL_SENSITIVITY  5
    #define J_STALL_SENSITIVITY  5
