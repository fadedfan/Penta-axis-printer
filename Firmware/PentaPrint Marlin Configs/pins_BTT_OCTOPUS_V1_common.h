...
#define I_DIAG_PIN                         PG13  // E1DET
#define J_DIAG_PIN                         PG14  // E2DET
...
#define J_MAX_PIN  Z2_DIAG_PIN       
  ...
  #if Y_HOME_TO_MIN
    #define Y_MAX_PIN                E0_DIAG_PIN  // E1DET
  #else
  ...
  #if Z_HOME_TO_MIN
    #define Z_MAX_PIN                E3_DIAG_PIN  // PWRDET
  #else
...
#define TEMP_CHAMBER_PIN                          PF7   // TH3
