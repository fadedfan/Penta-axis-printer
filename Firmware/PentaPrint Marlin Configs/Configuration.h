...
#define STRING_CONFIG_H_AUTHOR "(Shifan Liu, PentaPrint)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "PentaPrint 4.0.0"
 ...
 */
#ifdef I_DRIVER_TYPE
  #define AXIS4_NAME 'B' // :['A', 'B', 'C', 'U', 'V', 'W']
  #define AXIS4_ROTATES
#endif
#ifdef J_DRIVER_TYPE
  #define AXIS5_NAME 'C' // :['B', 'C', 'U', 'V', 'W']
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 3200/8, 17.78, 17.78, 280}
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 200, 300, 300, 80}
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 800, 4000, 4000, 4000 }
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_IJERK  1
  #define DEFAULT_JJERK  1
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {23, 5, 0, 5, 5}
...
// B and C axis travel speed (deg/min) 
#define I_PROBE_FEEDRATE (20*60)
#define J_PROBE_FEEDRATE (20*60)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_I_POINT 0 // Y point for Z homing
  #define Z_SAFE_HOMING_J_POINT 0 // Y point for Z homing
  //#define Z_SAFE_HOMING_POINT_ABSOLUTE  // Ignore home offsets (M206) for Z homing position
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (10*60), (100*60), (20*60)}
